...
public class AudioSlider extends JPanel{
    ...
    public AudioSlider(String pathname) {
...
//        add(currentDuration, gbc);
        JButton action = new JButton("Play");//o button do play chama-se action
        ...
        //hmm nao sei o que é isto mas ok
