...
public class javaFindConnect {
	public static void main(String[] args) throws Exception {
		//Exemplo de como usar matalab functions
		try {
	         ...
	         */
	            ...
	            System.out.println("\nFind numbers from a matrix that are less than five and square them:\n");
	            ...
	            int numberVar = 1;
	            ml.putVariableAsync("P", numberVar);
	            
	            ml.eval("y=P+3;plot(y:10); print('myPlot','-djpeg')");
